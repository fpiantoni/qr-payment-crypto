...
class WSDL {
  ...
  _initializeOptions(options) {
    ...
    this.options.xmlKey = options.xmlKey || this.xmlKey; // Allow any request headers to keep passing through
  ...
  _processNextInclude(syncLoad, includes, callback) {
    ...
    var self = this,
        ...
        options;
    if (!include) return callback(); // if undefined treat as "" to make path.dirname return '.' as errors on non string below
